...
import Notification, { Notification2 } from "../../components/Notification/Notification.js";
            ...
            <Col>
              <Widget>
                <div className={s.tableTitle}>
                  <div className="headline-2">Hoạt động chăm sóc khách hàng</div>
                  <div className="d-flex">
                    <button style={{ color: "white", background: "#4d53e0", borderRadius: "5px" }} onClick={handleShow}>Thêm hoạt động</button>
                      ...
                      {firstTable
                        ...
                        .map(item => (
                          <tr key={uuidv4()}>
                            ...
                            <td>{item.end_date}</td>
                            <td><td><i className="fa fa-edit" style={{ marginRight: "10px" }}></i><i className="fa fa-trash"></i></td></td>
                          </tr>
                        ))}
                    </tbody>
                  </Table>
